...
const List<String> kNationality = ['Choose Nation', 'Saudi Arabia', 'Kuwait', 'United Arab Emirates'];

final Map<String, Criterion> criteriaEmptyStateRanges = {
  "age": const RangeCriterion(
    from: 18,
    to: 85,
    name: "age",
  ),
  "height": const RangeCriterion(
    from: 110,
    to: 200,
    name: "height",
  ),
  "weight": const RangeCriterion(
    from: 40,
    to: 200,
    name: "weight",
  ),
  "income": const RangeCriterion(
    from: 0,
    to: 40000,
    name: "income",
  ),
  "gender": const ValueCriterion(
    condition: "",
    name: "gender",
  ),
  "nation": const ValueCriterion(
    condition: "",
    name: "nation",
  ),
};
...
final List<String> criteriaMenue = ["age", "height", "weight", "income", "gender", "nation"];
...
const Map<String, List<String>> criterionPickerList = {"gender": kGender, "nation": kNationality};
